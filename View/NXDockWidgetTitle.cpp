...
R"(QPushButton
{
    ...
    image: url(":/Dock/Resources/Image/pin_dockwidget_normal.png");
}
QPushButton:hover {
    image: url(":/Dock/Resources/Image/pin_dockwidget_hover.png");
}
QPushButton:pressed:hover {
    image: url(":/Dock/Resources/Image/pin_dockwidget_pressed.png");
})";
...
R"(QPushButton 
{
	border: 0px;
	width: 15px; height: 15px;
    image: url(":/Dock/Resources/Image/unpin_dockwidget_normal.png");
}
QPushButton:hover {
    image: url(":/Dock/Resources/Image/unpin_dockwidget_hover.png");
}
QPushButton:pressed:hover {
    image: url(":/Dock/Resources/Image/unpin_dockwidget_pressed.png");
})";
...
R"(QPushButton 
{
	border: 0px;
	width: 15px; height: 15px;
    image: url(":/Dock/Resources/Image/close_dockwidget_normal.png");
}
QPushButton:hover {
    image: url(":/Dock/Resources/Image/close_dockwidget_hover.png");
}
QPushButton:pressed:hover {
    image: url(":/Dock/Resources/Image/close_dockwidget_pressed.png");
})";
...
R"(QPushButton
{
	border: 0px;
	width: 15px; height: 15px;
    image: url(":/Dock/Resources/Image/menu_dockwidget_normal.png");
}
QPushButton:hover {
    image: url(":/Dock/Resources/Image/menu_dockwidget_hover.png");
}
QPushButton:pressed:hover {
    image: url(":/Dock/Resources/Image/menu_dockwidget_pressed.png");
})";
